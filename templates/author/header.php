...
$verified = get_user_meta( $author->id, 'verify_seller', true );
    ...
    <div class="directorist-card directorist-author-profile__wrap">
        ...
        <div class="directorist-author-avatar directorist-author-profile__avatar">
            ...
            <div class="directorist-author-avatar__info directorist-author-profile__avatar__info">
                <h2 class="directorist-author-name directorist-author-profile__avatar__info__name">
                    <?php echo esc_html( $author->display_name() ); ?>
                    <?php if( $is_verified ) { echo '<span class="directorist-sv-verified-badge-name">Verified</span>'; } ?>
                </h2>
